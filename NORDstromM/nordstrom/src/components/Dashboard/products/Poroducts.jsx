import { Box,Stack,Text,Badge,Tooltip ,Center, Image, Container, border, Input, IconButton,Button, Divider } from '@chakra-ui/react'
...
function Products() { 
    ...
    <Box maxW='sm'  overflow='hidden'>
      ...
      <Center  width={"90%"} margin="auto" marginTop={"100px"} bg={"black"} height='2px'>
