...
function BoxesFun() { 
    ...
    return (
      <Box justifyContent={"space-evenly"} display={"flex"} gap={"5"} width="95%" margin={"auto"} marginTop="50px">
        <a href="https://www.nordstrom.com/browse/x-nike/women?campaign=0822nxnhp&jid=-_-012813-19680&cm_sp=merch-_-olivia_kim_19680_-_-012813-_-hp_0_0_0&">
        ...
        <Box p='6'>
         ...
         <Box display={"flex"}>
          <Tooltip label="Shop NxN" aria-label='A tooltip'>
